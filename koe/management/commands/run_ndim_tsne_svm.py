...
from koe.ml_utils import classifiers, run_clustering, run_nfolds


reduce_funcs = {"ica": FastICA, "pca": PCA, "none": None}
...
class Command(BaseCommand):
    ...
    def handle(self, clsf_type, matfile, nfolds, niters, ndims, reduce_type, *args, **options):
        ...
        label_prediction_scores, _, _ = run_nfolds(
            tsne_results, nsyls, nfolds, niters, enum_labels, nlabels, classifier, bar
        )
