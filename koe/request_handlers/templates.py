...
from koe.model_utils import (
    assert_permission,
    get_or_error,
    get_user_accessible_databases,
    get_user_databases,
)
from koe.models import Database, DatabaseAssignment, DatabasePermission, TemporaryDatabase
...
def populate_context(obj, context):
    ...
    other_users = DatabaseAssignment.objects.filter(
        database__in=underlying_databases, permission__gte=DatabasePermission.VIEW
