...
class AudioFile(SimpleModel):
    ...
    track = models.ForeignKey(AudioTrack, null=False, blank=False, on_delete=models.CASCADE)
    individual = models.ForeignKey(Individual, null=False, blank=False, on_delete=models.CASCADE)
