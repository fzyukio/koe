...
urlpatterns += \
    [
        ...
        # url(r'^syllables/(?P<viewas>[0-9a-zA-Z-_]+)/$$', login_required(views.SyllablesView.as_view()),
        #     name='syllables'),
        ...
        # url(r'^songs/(?P<class>[0-9a-z-_]+)/(?P<viewas>[0-9a-zA-Z-_]+)/$',
        ...
        # url(r'^sequence-mining/(?P<class>[0-9a-z-_]+)/(?P<viewas>[0-9a-zA-Z-_]+)/$',
        ...
        #     name='exemplars'),
        # url(r'^exemplars/(?P<class>[0-9a-z-_]+)/(?P<viewas>[0-9a-zA-Z-_]+)/$',
        ...
        # url(r'^song-partition/(?P<track_id>[0-9]+)/$', login_required(views.SongPartitionView.as_view()),
        #     name='song-partition'),
