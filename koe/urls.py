...
urlpatterns += \
    [
        ...
        url(r'^syllables/(?P<from_user>[0-9a-z-_]+)/$$', login_required(views.SyllablesView.as_view()),
            name='syllables'),
        ...
        url(r'^songs/(?P<class>[0-9a-z-_]+)/(?P<from_user>[0-9a-z-_]+)/$',
        ...
        url(r'^song-partition/(?P<track_id>[0-9a-z-_]+)/$',
