import {ajaxStream, postRequest} from './ajax-handler';
...
const getWsConnection = function(token) {
    ...
    if (webSocket === undefined) {
        ...
        return new Promise(function(resolve, reject){
            // webSocket = new WebSocket("wss://go-llama-proxy.io.ac.nz/");
...
const sendWsMessage = function(webSocket, message, messageTextArea) {
    let messageBox = $("#message-box");
    let messageEl = renderOneMessage(
        nameMap[KOE], "..."
    );
...
var renderOneMessage = function (name, msg) {
    return $(`
        <div class="message">
...
var renderChatHistory = function (chatHistory) {
    let messageBox = $("#message-box");
    messageBox.html("");
...
var initChatSubmitButton = function (_chatHistory) {
