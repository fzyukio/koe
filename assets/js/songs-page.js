...
const initDeleteSongsBtn = function () {
  deleteSongsBtn.click(function () {
    ...
    ce
      .dialogModalBody.html(`Are you sure you want to delete these songs and all data associated with it? 
...
const initCopySongsBtn = function () {
  copySongsBtn.click(function () {
    ...
    ce
      .dialogModalBody.html(`Please provide the name of the target database for these files to be copied to. 
