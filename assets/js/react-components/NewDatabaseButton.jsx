  ...
  render() {
    ...
    return (
      <Form horizontal onSubmit={this.handleSubmit} id="newDatabaseForm">
        ...
        <FormGroup>
          ...
          <Col sm={8}>
            <Dropdown
              ...
              itemKey="overlaps"
              selectedKey="new-database-overlap"
        ...
        <FormGroup>
          <Col sm={4}>High pass filter</Col>
          <Col sm={8}>
            <FormControl
              type="number"
              placeholder="E.g. 100Hz, default is 0 (no filter)"
        ...
        <FormGroup>
          <Col sm={4}>Low pass filter</Col>
          <Col sm={8}>
            <FormControl
              className={lpfError ? "has-error" : ""}
              type="number"
